...
export const ravensGateCase: Case = {
  ...
  brief: 'Lord Edmund Ashworth, 61, was found dead in his study at Raven\'s Gate manor on the morning of 14th November 1891. The family physician noted an unusual pallor and a faint sweet-almond odour. The second physician detected petechial haemorrhaging. The case was reopened. Someone in the house knows what happened.',
  briefAr: 'وُجد اللورد إدموند أشوورث، 61 عاماً، ميتاً في مكتبته في قصر بوابة الغراب صباح 14 نوفمبر 1891. لاحظ طبيب العائلة شحوباً غير عادي ورائحة لوز حلو خفيفة. اكتشف الطبيب الثاني نزيفاً نمشياً. أُعيد فتح القضية. شخص في المنزل يعرف ما حدث.',
      ...
      clues: [
        {
          ...
          digest: 'Heavy bootprints in fresh mud on the doormat. Size nine, cross-hatched sole. One set inward, one outward — the outward prints are deeper at the toe, suggesting someone leaving in haste.',
          digestAr: 'آثار أحذية ثقيلة في طين طري على حصيرة الباب. مقاس تسعة، نعل متقاطع. مجموعة للداخل وأخرى للخارج — بصمات الخروج أعمق عند الأصابع، توحي بشخص يغادر على عجل.',
        ...
        },
        {
          ...
          name: 'Visiting Card',
          nameAr: 'بطاقة زيارة',
          digest: 'A cream-coloured visiting card on the salver: "Dr. S. Morrow, M.D. — 14 Harley Street." The corner is bent, the surface smudged with fresh oil — handled recently and put down.',
          digestAr: 'بطاقة زيارة بلون كريمي على الصينية: "د. س. مورو، طبيب — 14 شارع هارلي." الزاوية مطوية، السطح ملطخ بزيت طازج — استُعملت حديثاً ووضعت.',
      ...
      clues: [
        {
          ...
          digest: 'A porcelain teacup with dark residue inside. Sweet-almond smell. Hairline chip on the left rim. The residue at the bottom is thicker than tea should leave — almost syrupy.',
          digestAr: 'فنجان شاي خزفي ببقايا داكنة في الداخل. رائحة لوز حلو. شرخ شعري على الحافة اليسرى. البقايا في القاع أثخن مما يتركه الشاي — شبه شرابية.',
        ...
        },
        {
          ...
          digest: 'A tiny piece of white porcelain on the hearth. Sharp edge — freshly broken. Matches the chipped teacup exactly.',
          digestAr: 'قطعة صغيرة من الخزف الأبيض على المدفأة. حافة حادة — مكسورة حديثاً. تطابق فنجان الشاي المشروخ تماماً.',
        ...
        },
        {
          ...
          nameAr: 'كتاب مقلوب',
          digest: 'A book of Tennyson\'s poetry on the floor, dropped in haste. A pressed white rose marks a page in "In Memoriam."',
          digestAr: 'كتاب شعر تنيسون ملقى على الأرض، أُسقط بعجلة. وردة بيضاء مجففة تعلّم صفحة في "In Memoriam."',
        ...
        },
        {
          ...
          digest: 'Two cups on the silver tray — one used (the chipped one), one unused. Set for two, but only one drank.',
          digestAr: 'فنجانان على الصينية الفضية — واحد مستعمل (المشروخ)، والآخر غير مستعمل. لشخصين، لكن واحداً فقط شرب.',
      ...
      clues: [
        {
          ...
          digest: 'The desk drawer contains: a brass key on a ribbon, an unsigned letter ("I know what you have done"), and a memorandum book of accounts in two different hands.',
          digestAr: 'درج المكتب يحتوي: مفتاح نحاسي بشريط، رسالة غير موقعة ("أعرف ما فعلته")، ودفتر مذكرات لحسابات بخطين مختلفين.',
        ...
        },
        {
          ...
          digest: 'A small brass key on a velvet ribbon. Paper tag reads "Anteroom — Miss Hartley." The teeth are clean — recently used.',
          digestAr: 'مفتاح نحاسي صغير بشريط مخملي. ملصق ورقي يقرأ "الغرفة المجاورة — آنسة هارتلي." الأسنان نظيفة — استُعمل حديثاً.',
        ...
        },
        {
          ...
          digest: 'A half-full brandy decanter with two glasses — one used and rinsed, one clean. The rinsed glass still carries a faint sweet trace.',
          digestAr: 'دورق براندي نصف ممتلئ بكأسين — واحد مستعمل ومغسول، والآخر نظيف. الكأس المغسولة لا تزال تحمل أثراً حلواً خافتاً.',
        ...
        },
        {
          ...
          digest: 'The desk diary shows yesterday: "11am — C.H. re: W.W.R.F. accounts." The "C.H." entry is underlined twice in a different pen — added later.',
          digestAr: 'دفتر المواعيد يُظهر أمس: "11 صباحاً — ج.ه. بشأن حسابات صندوق الأرامل." مدخلة "ج.ه." تحتها خط مرتين بقلم مختلف — أُضيفت لاحقاً.',
      ...
      clues: [
        {
          ...
          digest: 'A desk with a slightly open drawer. Inside: a document comparing Whitechapel Widows\' Fund donations to disbursements — the figures do not match. A significant discrepancy.',
          digestAr: 'مكتب بدرج مفتوح قليلاً. في الداخل: وثيقة تقارن تبرعات صندوق أرامل وايتشابل بالمصروفات — الأرقام غير متطابقة. فارق كبير.',
        ...
        },
        {
          ...
          nameAr: 'ظرف مهمل',
          digest: 'A torn envelope in the bin, addressed "Miss C. Hartley, private." Postmarked 11th November, three days ago. Return address: a solicitor in Gray\'s Inn. The letter inside is gone.',
          digestAr: 'ظرف ممزق في السلة، موجه إلى "الآنسة ج. هارتلي، شخصي." طابع بريدي 11 نوفمبر، قبل ثلاثة أيام. عنوان المرسل: محامٍ في غراي\'s إن. الرسالة اختفت.',
        ...
        },
        {
          ...
          digest: 'A silver-framed portrait of an older woman. A worn copy of "The Woman in White" with annotations in the same handwriting as the letter in the study. Read many times.',
          digestAr: 'صورة بإطار فضي لامرأة مسنة. نسخة قديمة من "المرأة بالأبيض" بحواشٍ بنفس خط الرسالة في المكتبة. قُرئت مرات عديدة.',
      ...
      clues: [
        {
          ...
          digest: 'The staff timetable shows a pencilled note beside "Evening tea service (8pm, drawing room)": "Miss H. — special request." An unusual deviation from standard service.',
          digestAr: 'جدول الخدم يظهر ملاحظة بقلم الرصاص بجانب "خدمة الشاي المسائية (8 مساءً، غرفة الاستقبال)": "الآنسة ه. — طلب خاص." انحراف غير معتاد عن الخدمة القياسية.',
        ...
        },
        {
          ...
          digest: 'A heavy iron key labelled "Darkroom — Lord A." The hook beside it, "Anteroom — Miss H.," is empty — someone removed the anteroom key.',
          digestAr: 'مفتاح حديدي ثقيل مكتوب عليه "غرفة التحميض — اللورد أ." الخطاف المجاور "الغرفة المجاورة — آنسة ه." فارغ — أحدهم أخذ مفتاح الغرفة المجاورة.',
      ...
      clues: [
        {
          ...
          digest: 'Mrs. Rowe\'s personal accounts ledger: "Wages owed: £23 10s. Three months. He will pay." The ink is recent — written within the last day.',
          digestAr: 'دفتر حسابات السيدة رو الشخصي: "الأجور المستحقة: £23 10s. ثلاثة أشهر. سيدفع." الحبر حديث — كُتب خلال اليوم الماضي.',
        ...
        },
        {
          ...
          digest: 'A box of glass photographic plates. One sleeve is empty and smells faintly sweet — like almonds. The empty sleeve is slightly damp inside.',
          digestAr: 'صندوق ألواح تصوير زجاجية. غمد واحد فارغ ورائحته حلوة خفيفة — مثل اللوز. الغمد الفارغ رطب قليلاً من الداخل.',
      ...
      clues: [
        {
          ...
          digest: 'A rack of photographic chemicals. One bottle is missing — "Potassium Cyanide (KCN) — Fixing Agent." The absence is conspicuous. The sweet-almond smell is strongest at the empty slot.',
          digestAr: 'رف من الكيماويات الفوتوغرافية. زجاجة واحدة مفقودة — "سيانيد البوتاسيوم — مادة التثبيت." الغياب لافت. رائحة اللوز الحلو أقوى عند المكان الفارغ.',
        ...
        },
        {
          ...
          nameAr: 'حوض التحميض',
          digest: 'A developing basin that was rinsed but not dried. A pale yellow crystalline residue along the interior edge. The same sweet-almond chemical smell.',
          digestAr: 'حوض تحميض غُسل لكن لم يُجفف. بقايا بلورية صفراء باهتة على طول الحافة الداخلية. نفس رائحة المادة الكيميائية الحلوة كاللوز.',
...
ملاحظات التوثيق:
  ...
  timeline: [
    { id: 'rg_tl_1', time: '7:00 PM', timeAr: '7:00 مساءً', description: 'Marcus Sterling arrives. Shown to drawing room. Constance serves cocktails.', descriptionAr: 'ماركوس ستيرلينغ يصل. يُودع غرفة الاستقبال. كونستانس تقدم المشروبات.' },
    { id: 'rg_tl_2', time: '7:20 PM', timeAr: '7:20 مساءً', description: 'Marcus enters the study with Lord Ashworth. Raised voices heard at 7:45.', descriptionAr: 'ماركوس يدخل المكتبة مع اللورد أشوورث. تُسمع أصوات مرتفعة في 7:45.' },
    { id: 'rg_tl_3', time: '8:00 PM', timeAr: '8:00 مساءً', description: 'Constance serves tea directly to Lord Ashworth — unusual. Marcus leaves the study alone.', descriptionAr: 'كونستانس تقدم الشاي مباشرة للورد أشوورث — غير معتاد. ماركوس يغادر المكتبة وحده.' },
    { id: 'rg_tl_4', time: '8:30 PM', timeAr: '8:30 مساءً', description: 'Constance claims to leave the manor. No witness to her departure.', descriptionAr: 'كونستانس تدّعي مغادرة القصر. لا شاهد على مغادرتها.' },
    { id: 'rg_tl_5', time: '7:00 AM', timeAr: '7:00 صباحاً', description: 'Lord Ashworth found dead in his study by Mrs. Rowe.', descriptionAr: 'اللورد أشوورث يُوجد ميتاً في مكتبته على يد السيدة رو.' },
  ],
